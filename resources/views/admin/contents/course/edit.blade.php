      ...
      <div class="card-body">
        <form action="/admin/student/update/{{ $student->id }}" method="post" class="mt-3">
            ...
            <div class="mb-2">
                ...
                <input type="text" name="name" id="name" class="form-control" values="{{ $student->name ?? '' }}">
            </div>

            <div class="mb-2">
                <label for="nim" class="form-label">NIM</label>
                <input type="text" name="nim" id="nim" class="form-control" values="{{ $student->nim ?? '' }}">
            </div>
            ...
            <div class="mb-2">
                ...
                <input type="text" name="class" id="class" class="form-control" values="{{ $student->class ?? '' }}">
            </div>
